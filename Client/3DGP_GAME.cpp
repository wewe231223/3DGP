// 3DGP_GAME.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
std::unique_ptr<Engine> GameRenderEngine{};
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY3DGPGAME, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY3DGPGAME));
...
HWND InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      100, 100, 1920, 1080, nullptr, nullptr, hInstance, nullptr);
